...
#                 footer_credit = "🦋<a href='https://telegram.me/ULTRONBOTS'>• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •</a>══<a href='https://telegram.me/SOLO_DARE'>• ᴄᴏɴᴛᴀᴄᴛ ᴍᴀꜱᴛᴇʀ •</a>🦋"
...
#                 print(error)
#                 await message.reply_text(f'Error means lazy came 😀\n\n{error}')
#     else:
#         return
